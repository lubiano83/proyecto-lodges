...
export default function RegisterForm() {
  ...
  const { registerUser,email, setEmail, name, setName, lastname, setLastname, phone, setPhone, country, setCountry, state, setState, address, setAddress, password, setPassword } = useAuth();
